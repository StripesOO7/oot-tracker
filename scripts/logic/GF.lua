...
Child_GF_Storms_Grotto:connect_one_way("Free Fairies", function() return Has("Bottle") end)

Adult_GF_Storms_Grotto:connect_one_way("Free Fairies", function() return Has("Bottle") end)
