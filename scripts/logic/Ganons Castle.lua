...
Child_Castle_Grounds_From_Ganons_Castle:connect_one_way_entrance("Child Ganons Castle Grounds", function() 
    return All(
        false, 
        Tracker:FindObjectForCode("bridge").CurrentStage == 0
    ) 
end)
Adult_Castle_Grounds_From_Ganons_Castle:connect_one_way_entrance("Adult Ganons Castle Grounds", function() 
    return All(
        true, 
        Tracker:FindObjectForCode("bridge").CurrentStage == 0
    ) 
...
Child_Ganons_Castle_Grounds:connect_one_way_entrance("Child Castle Grounds")
Child_Ganons_Castle_Grounds:connect_one_way_entrance("Child OGC Great Fairy Fountain", function() 
    return All(
        Can_use("GoldenGauntlets")--,
        -- at_dampe_time
    ) 
end)
Child_Ganons_Castle_Grounds:connect_one_way_entrance("Child Ganons Castle Lobby", function() 
    return All(
...
Adult_Ganons_Castle_Grounds:connect_one_way_entrance("Adult Castle Grounds")
Adult_Ganons_Castle_Grounds:connect_one_way_entrance("Adult OGC Great Fairy Fountain", function() 
    return All(
        Can_use("GoldenGauntlets")--,
        -- at_dampe_time
    ) 
end)
Adult_Ganons_Castle_Grounds:connect_one_way_entrance("Adult Ganons Castle Lobby", function() 
    return All(
        Can_build_rainbow_bridge()--,
        -- at_dampe_time
    ) 
...
Child_OGC_Great_Fairy_Fountain:connect_one_way_entrance("Child Castle Grounds")
Adult_OGC_Great_Fairy_Fountain:connect_one_way_entrance("Adult Castle Grounds")
