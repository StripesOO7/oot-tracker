...
Child_Dodongos_Cavern_Lobby:connect_one_way_entrance("Child Dodongos Cavern Staircase Room", Child_Dodongos_Cavern_Staircase_Room, function() 
    return All(
        Child_Dodongos_Cavern_Torch_Room.accessibility_level,
        Any(
            false,
...
Child_Dodongos_Cavern_Lobby:connect_one_way_entrance("Child Dodongos Cavern Far Bridge", Child_Dodongos_Cavern_Far_Bridge, function() return Child_Dodongos_Cavern_Far_Bridge.accessibility_level end)
...
Adult_Dodongos_Cavern_Lobby:connect_one_way_entrance("Adult Dodongos Cavern Staircase Room", Adult_Dodongos_Cavern_Staircase_Room, function() 
    return All(
        Adult_Dodongos_Cavern_Torch_Room.accessibility_level,
        Any(
            true,
...
Adult_Dodongos_Cavern_Lobby:connect_one_way_entrance("Adult Dodongos Cavern Far Bridge", Adult_Dodongos_Cavern_Far_Bridge, function() return Adult_Dodongos_Cavern_Far_Bridge.accessibility_level end)
...
Child_Dodongos_Cavern_Staircase_Room:connect_one_way("Child Dodongos Cavern GS Vines Above Stairs", function() 
    return Any(
        Child_Dodongos_Cavern_Climb.accessibility_level,
        All(
...
Adult_Dodongos_Cavern_Staircase_Room:connect_one_way("Adult Dodongos Cavern GS Vines Above Stairs", function() 
    return Any(
        Adult_Dodongos_Cavern_Climb.accessibility_level,
        All(
            Has("logic_dc_vines_gs"),
            Can_use("Longshot", "adult")
        )
...
Child_Dodongos_Cavern_Climb:connect_one_way("Child Dodongos Cavern Blade Room Pot 1", function() 
    return Any(
        Can_use("Boomerang", "child"),
        Child_Dodongos_Cavern_Far_Bridge.accessibility_level
    ) 
end)
...
Adult_Dodongos_Cavern_Climb:connect_one_way("Adult Dodongos Cavern Blade Room Pot 1", function() 
    return Any(
        Can_use("Boomerang", "adult"),
        Adult_Dodongos_Cavern_Far_Bridge.accessibility_level
    ) 
end)
