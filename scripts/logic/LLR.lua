...
Child_Lon_Lon_Ranch:connect_one_way("Song from Malon", function()
    return All(
        Has("ZeldasLetter"),
        Has("Ocarina")
    )
end)
Child_Lon_Lon_Ranch:connect_one_way("LLR Front Pot 1")
Child_Lon_Lon_Ranch:connect_one_way("LLR Front Pot 2")
Child_Lon_Lon_Ranch:connect_one_way("LLR Front Pot 3")
Child_Lon_Lon_Ranch:connect_one_way("LLR Front Pot 4")
Child_Lon_Lon_Ranch:connect_one_way("LLR Rain Shed Pot 1")
Child_Lon_Lon_Ranch:connect_one_way("LLR Rain Shed Pot 2")
Child_Lon_Lon_Ranch:connect_one_way("LLR Rain Shed Pot 3")
Child_Lon_Lon_Ranch:connect_one_way("LLR Child Crate")
Child_Lon_Lon_Ranch:connect_one_way("LLR GS Tree", function() return can_break_crate end)
Child_Lon_Lon_Ranch:connect_one_way("LLR GS Rain Shed", function() return CanBonk() end)
Child_Lon_Lon_Ranch:connect_one_way("LLR GS House Window", function() return Has("Boomerang") end)
Child_Lon_Lon_Ranch:connect_one_way("LLR GS Back Wall", function() return Has("Boomerang") end)

Adult_Lon_Lon_Ranch:connect_one_way("LLR GS House Window", function() return Has("Boomerang") end)
Adult_Lon_Lon_Ranch:connect_one_way("LLR GS Back Wall", function() return Has("Boomerang") end)
