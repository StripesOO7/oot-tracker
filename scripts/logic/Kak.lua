...
Child_Kakariko_Village:connect_one_way_entrance("Child Hyrule Field", , )
Child_Kakariko_Village:connect_one_way_entrance("Child Kak Carpenter Boss House", , )
Child_Kakariko_Village:connect_one_way_entrance("Child Kak House of Skulltula", , )
Child_Kakariko_Village:connect_one_way_entrance("Child Kak Impas House", , )
Child_Kakariko_Village:connect_one_way_entrance("Child Kak Windmill", , )
Child_Kakariko_Village:connect_one_way_entrance("Child Kak Bazaar", , is_adult and at_day)
Child_Kakariko_Village:connect_one_way_entrance("Child Kak Shooting Gallery", , is_adult and at_day)
Child_Kakariko_Village:connect_one_way_entrance("Child Bottom of the Well", , 'Drain Well' and (is_child or shuffle_dungeon_entrances))
Child_Kakariko_Village:connect_one_way_entrance("Child Kak Potion Shop Front", , is_child or at_day)
Child_Kakariko_Village:connect_one_way_entrance("Child Kak Redead Grotto", , can_open_bomb_grotto)
Child_Kakariko_Village:connect_one_way_entrance("Child Kak Impas Ledge", , (is_child and at_day) or (is_adult and logic_visible_collisions))
Child_Kakariko_Village:connect_one_way_entrance("Child Kak Impas Rooftop", , can_use(Hookshot) or (logic_kakariko_rooftop_gs and can_use(Hover_Boots)))
Child_Kakariko_Village:connect_one_way_entrance("Child Kak Odd Medicine Rooftop", , can_use(Hookshot) or
...
Child_Kakariko_Village:connect_one_way_entrance("Child Kak Backyard", , is_adult or at_day)
Child_Kakariko_Village:connect_one_way_entrance("Child Graveyard", , )
Child_Kakariko_Village:connect_one_way_entrance("Child Kak Behind Gate", , is_adult or 'Kakariko Village Gate Open')

Adult_Kakariko_Village:connect_one_way_entrance("Adult Hyrule Field", , )
Adult_Kakariko_Village:connect_one_way_entrance("Adult Kak Carpenter Boss House", , )
Adult_Kakariko_Village:connect_one_way_entrance("Adult Kak House of Skulltula", , )
Adult_Kakariko_Village:connect_one_way_entrance("Adult Kak Impas House", , )
Adult_Kakariko_Village:connect_one_way_entrance("Adult Kak Windmill", , )
Adult_Kakariko_Village:connect_one_way_entrance("Adult Kak Bazaar", , is_adult and at_day)
Adult_Kakariko_Village:connect_one_way_entrance("Adult Kak Shooting Gallery", , is_adult and at_day)
Adult_Kakariko_Village:connect_one_way_entrance("Adult Bottom of the Well", , 'Drain Well' and (is_child or shuffle_dungeon_entrances))
Adult_Kakariko_Village:connect_one_way_entrance("Adult Kak Potion Shop Front", , is_child or at_day)
Adult_Kakariko_Village:connect_one_way_entrance("Adult Kak Redead Grotto", , can_open_bomb_grotto)
Adult_Kakariko_Village:connect_one_way_entrance("Adult Kak Impas Ledge", , (is_child and at_day) or (is_adult and logic_visible_collisions))
Adult_Kakariko_Village:connect_one_way_entrance("Adult Kak Impas Rooftop", , can_use(Hookshot) or (logic_kakariko_rooftop_gs and can_use(Hover_Boots)))
Adult_Kakariko_Village:connect_one_way_entrance("Adult Kak Odd Medicine Rooftop", , can_use(Hookshot) or
(logic_man_on_roof and
    (is_adult or at_day or Slingshot or has_bombchus or
        (logic_kakariko_tower_gs and (Sticks or Kokiri_Sword)))))
Adult_Kakariko_Village:connect_one_way_entrance("Adult Kak Backyard", , is_adult or at_day)
Adult_Kakariko_Village:connect_one_way_entrance("Adult Graveyard", , )
Adult_Kakariko_Village:connect_one_way_entrance("Adult Kak Behind Gate", , is_adult or 'Kakariko Village Gate Open')

-- Child_Kak_Impas_Ledge:connect_one_way()
-- Adult_Kak_Impas_Ledge:connect_one_way()

Child_Kak_Impas_Ledge:connect_one_way_entrance("Child Kak Impas House Back")
Child_Kak_Impas_Ledge:connect_one_way_entrance("Child Kakariko Village")

Adult_Kak_Impas_Ledge:connect_one_way_entrance("Adult Kak Impas House Back")
Adult_Kak_Impas_Ledge:connect_one_way_entrance("Adult Kakariko Village")
...
Child_Kak_Impas_Rooftop:connect_one_way_entrance("Child Kak Impas Ledge")
Child_Kak_Impas_Rooftop:connect_one_way_entrance("Child Kakariko Village")

Adult_Kak_Impas_Rooftop:connect_one_way_entrance("Adult Kak Impas Ledge")
Adult_Kak_Impas_Rooftop:connect_one_way_entrance("Adult Kakariko Village")
...
Child_Kak_Odd_Medicine_Rooftop:connect_one_way_entrance("Child Kakariko Village")
Child_Kak_Odd_Medicine_Rooftop:connect_one_way_entrance("Child Kak Backyard")

Adult_Kak_Odd_Medicine_Rooftop:connect_one_way_entrance("Adult Kakariko Village")
Adult_Kak_Odd_Medicine_Rooftop:connect_one_way_entrance("Adult Kak Backyard")
...
Child_Kak_Backyard:connect_one_way_entrance("Child Kakariko Village")
Child_Kak_Backyard:connect_one_way_entrance("Child Kak Open Grotto")
-- Child_Kak_Backyard:connect_one_way_entrance("Child Kak Odd Medicine Building", is_adult)
-- Child_Kak_Backyard:connect_one_way_entrance("Child Kak Potion Shop Back", is_adult and at_day)

Adult_Kak_Backyard:connect_one_way_entrance("Adult Kakariko Village")
Adult_Kak_Backyard:connect_one_way_entrance("Adult Kak Open Grotto")
Adult_Kak_Backyard:connect_one_way_entrance("Adult Kak Odd Medicine Building", is_adult)
Adult_Kak_Backyard:connect_one_way_entrance("Adult Kak Potion Shop Back", is_adult and at_day)
...
Child_Kak_Carpenter_Boss_House:connect_one_way_entrance("Child Kakariko Village")
Adult_Kak_Carpenter_Boss_House:connect_one_way_entrance("Adult Kakariko Village")
...
Child_Kak_House_of_Skulltula:connect_one_way_entrance("Child Kakariko Village")
Adult_Kak_House_of_Skulltula:connect_one_way_entrance("Adult Kakariko Village")

-- Child_Kak_Impas_House:connect_one_way()
-- Adult_Kak_Impas_House:connect_one_way()

Child_Kak_Impas_House:connect_one_way_entrance("Child Kakariko Village")
Child_Kak_Impas_House:connect_one_way_entrance("Child Kak Impas House Near Cow")

Adult_Kak_Impas_House:connect_one_way_entrance("Adult Kakariko Village")
Adult_Kak_Impas_House:connect_one_way_entrance("Adult Kak Impas House Near Cow")
...
Child_Kak_Impas_House_Back:connect_one_way_entrance("Child Kak Impas Ledge")
Child_Kak_Impas_House_Back:connect_one_way_entrance("Child Kak Impas House Near Cow")

Adult_Kak_Impas_House_Back:connect_one_way_entrance("Adult Kak Impas Ledge")
Adult_Kak_Impas_House_Back:connect_one_way_entrance("Adult Kak Impas House Near Cow")


Child_Kak_Impas_House_Near_Cow:connect_one_way("Child Kak Impas House Cow")
Adult_Kak_Impas_House_Near_Cow:connect_one_way("Adult Kak Impas House Cow")
...
Child_Kak_Windmill:connect_one_way_entrance("Child Kakariko Village")
Adult_Kak_Windmill:connect_one_way_entrance("Adult Kakariko Village")
...
Child_Kak_Bazaar:connect_one_way_entrance("Child Kakariko Village")
Adult_Kak_Bazaar:connect_one_way_entrance("Adult Kakariko Village")
...
Child_Kak_Shooting_Gallery:connect_one_way_entrance("Child Kakariko Village")
Adult_Kak_Shooting_Gallery:connect_one_way_entrance("Adult Kakariko Village")
...
Child_Kak_Potion_Shop_Front:connect_one_way_entrance("Child Kakariko Village")
-- Child_Kak_Potion_Shop_Front:connect_one_way_entrance("Child Kak Potion Shop Back", is_adult)

Adult_Kak_Potion_Shop_Front:connect_one_way_entrance("Adult Kakariko Village")
Adult_Kak_Potion_Shop_Front:connect_one_way_entrance("Adult Kak Potion Shop Back", is_adult)


-- Child_Kak_Potion_Shop_Back:connect_one_way()
-- Adult_Kak_Potion_Shop_Back:connect_one_way()

-- Child_Kak_Potion_Shop_Back:connect_one_way_entrance("Child Kak Backyard", is_adult)
Child_Kak_Potion_Shop_Back:connect_one_way_entrance("Child Kak Potion Shop Front")

Adult_Kak_Potion_Shop_Back:connect_one_way_entrance("Adult Kak Backyard", is_adult)
Adult_Kak_Potion_Shop_Back:connect_one_way_entrance("Adult Kak Potion Shop Front")
...
Child_Kak_Odd_Medicine_Building:connect_one_way_entrance("Child Kak Backyard")
Adult_Kak_Odd_Medicine_Building:connect_one_way_entrance("Adult Kak Backyard")

-- Child_Kak_Behind_Gate:connect_one_way()
-- Adult_Kak_Behind_Gate:connect_one_way()

Child_Kak_Behind_Gate:connect_one_way_entrance("Child Kakariko Village", is_adult or logic_visible_collisions or 'Kakariko Village Gate Open' or open_kakariko == 'open')
Child_Kak_Behind_Gate:connect_one_way_entrance("Child Death Mountain")

Adult_Kak_Behind_Gate:connect_one_way_entrance("Adult Kakariko Village", is_adult or logic_visible_collisions or 'Kakariko Village Gate Open' or open_kakariko == 'open')
Adult_Kak_Behind_Gate:connect_one_way_entrance("Adult Death Mountain")
...
Child_Kak_Redead_Grotto:connect_one_way_entrance("Child Kakariko Village")
Adult_Kak_Redead_Grotto:connect_one_way_entrance("Adult Kakariko Village")
...
Child_Kak_Open_Grotto:connect_one_way_entrance("Child Kak Backyard")
Adult_Kak_Open_Grotto:connect_one_way_entrance("Adult Kak Backyard")
