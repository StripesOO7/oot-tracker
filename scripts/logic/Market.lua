...
Child_Market:connect_one_way_entrance("Child Market Bombchu Bowling", Child_Market_Bomchu_Bowling, function() return true end)
...
Adult_Market:connect_one_way_entrance("Adult Market Bazaar", Adult_Market_Bazaar, function() return true end)
Adult_Market:connect_one_way_entrance("Adult Market Mask Shop", Adult_Market_Mask_Shop, function() return true end)
Adult_Market:connect_one_way_entrance("Adult Market Shooting Gallery", Adult_Market_Shooting_Gallery, function() return true end)
Adult_Market:connect_one_way_entrance("Adult Market Bombchu Bowling", Adult_Market_Bomchu_Bowling, function() return true end)
Adult_Market:connect_one_way_entrance("Adult Market Potion Shop", Adult_Market_Potion_Shop, function() return true end)
Adult_Market:connect_one_way_entrance("Adult Market Treasure Chest Game", Adult_Market_Treasure_Chest_Game, function() return true end)
...
Child_Market_Mask_Shop:connect_one_way("Child Mask of Truth", function()
    return Any(
        Has("complete_mask_quest"),
        All(
            Child_Lost_Woods.accessibility_level >5,
            Can_play("SariasSong"),
            Child_Graveyard.accessibility_level >5,
            Child_Hyrule_Fields.accessibility_level >5,
            Has_all_stones()
        )
    )
end)
...
Child_Market_Bomchu_Bowling:connect_one_way("Child Market Bombchu Bowling First Prize", function() return Has_bombchus() end)
Child_Market_Bomchu_Bowling:connect_one_way("Child Market Bombchu Bowling Second Prize", function() return Has_bombchus() end)
Child_Market_Bomchu_Bowling:connect_one_way("Child Market Bombchu Bowling Bombchus", function() return Has_bombchus() end)

Adult_Market_Bomchu_Bowling:connect_one_way("Adult Market Bombchu Bowling First Prize", function() return Has_bombchus() end)
Adult_Market_Bomchu_Bowling:connect_one_way("Adult Market Bombchu Bowling Second Prize", function() return Has_bombchus() end)
Adult_Market_Bomchu_Bowling:connect_one_way("Adult Market Bombchu Bowling Bombchus", function() return Has_bombchus() end)

Child_Market_Bomchu_Bowling:connect_one_way_entrance("Child Markt", Child_Market)
Adult_Market_Bomchu_Bowling:connect_one_way_entrance("Adult Market", Adult_Market)
