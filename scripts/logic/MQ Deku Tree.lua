...
Child_Deku_Tree_Lobby:connect_one_way("Child Deku Tree MQ Lobby Crate", function() return can_break_crate end)
Child_Deku_Tree_Lobby:connect_one_way("Child Deku Tree MQ Slingshot Room Crate 1", function() return can_break_crate end)
Child_Deku_Tree_Lobby:connect_one_way("Child Deku Tree MQ Slingshot Room Crate 2", function() return can_break_crate end)
Child_Deku_Tree_Lobby:connect_one_way("Child Deku Tree MQ GS Lobby", function() 
    return is_adult or Sticks or KokiriSword or has_explosives or can_use(DinsFire) or
...
Adult_Deku_Tree_Lobby:connect_one_way("Adult Deku Tree MQ Lobby Crate", function() return can_break_crate end)
Adult_Deku_Tree_Lobby:connect_one_way("Adult Deku Tree MQ Slingshot Room Crate 1", function() return can_break_crate end)
Adult_Deku_Tree_Lobby:connect_one_way("Adult Deku Tree MQ Slingshot Room Crate 2", function() return can_break_crate end)
...
Child_Deku_Tree_Lobby:connect_one_way_entrance("Child ")
Adult_Deku_Tree_Lobby:connect_one_way_entrance("Adult ")

Child_Deku_Tree_Before_Boss:connect_one_way("Child ")
Adult_Deku_Tree_Before_Boss:connect_one_way("Adult ")

Child_Deku_Tree_Before_Boss:connect_one_way_entrance("Child ")
Adult_Deku_Tree_Before_Boss:connect_one_way_entrance("Adult ")

Child_Deku_Tree_Near_Compass_Room:connect_one_way("Child ")
Adult_Deku_Tree_Near_Compass_Room:connect_one_way("Adult ")

Child_Deku_Tree_Near_Compass_Room:connect_one_way_entrance("Child ")
Adult_Deku_Tree_Near_Compass_Room:connect_one_way_entrance("Adult ")

Child_Deku_Tree_Compass_Room:connect_one_way("Child ")
Adult_Deku_Tree_Compass_Room:connect_one_way("Adult ")

Child_Deku_Tree_Compass_Room:connect_one_way_entrance("Child ")
Adult_Deku_Tree_Compass_Room:connect_one_way_entrance("Adult ")

Child_Deku_Tree_Basement_Water_Room_Front:connect_one_way("Child ")
Adult_Deku_Tree_Basement_Water_Room_Front:connect_one_way("Adult ")

Child_Deku_Tree_Basement_Water_Room_Front:connect_one_way_entrance("Child ")
Adult_Deku_Tree_Basement_Water_Room_Front:connect_one_way_entrance("Adult ")

Child_Deku_Tree_Basement_Water_Room_Back:connect_one_way("Child ")
Adult_Deku_Tree_Basement_Water_Room_Back:connect_one_way("Adult ")

Child_Deku_Tree_Basement_Water_Room_Back:connect_one_way_entrance("Child ")
Adult_Deku_Tree_Basement_Water_Room_Back:connect_one_way_entrance("Adult ")
